package live.wallet.tomcat.v10.realm;
...
public class SimpleRealm implements Realm {
	...
	private List<SimpleRealm.User> users = new ArrayList<SimpleRealm.User>();
	...
	private User getUser(String username, String password) {
		Iterator<SimpleRealm.User> iterator = users.iterator();
